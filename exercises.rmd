...
* In the cat tree, which node represents the most recent common ancestor of the lion (*Panthera leo*) and the domesticated cat (*Felis silvestris*). How old is this ancestor?

* What is the evolutionary distance between *Lynx rufus* and *Puma concolor*?

* Produce a second plot of *just* the clade you selected in the previous question.
...
* How much is phylogenetic diversity reduced with the extinction of the snow leopard (*Uncia uncia*)?
